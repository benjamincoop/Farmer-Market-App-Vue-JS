var collapsibleComponent = Vue.component('collapsibleCategory', {
  ...
  template: `<div><div v-for="cat in categories"><button class="collapsible" v-on:click.self='toggleCollapse($event)'>{{ cat.name }}</button><div class="content">some text</div></div></div>`
})
